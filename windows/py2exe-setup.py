...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "R.U.T."
 
        #Project url
        self.project_url = "about:none"
 
        #Version of program
        self.project_version = "0.0.10"
 
        #License of the program
        self.license = "?"
 
        #Auhor of program
        self.author_name = "Rockwell Game Studio"
        self.author_email = "rockwellgamestudio@gmail.com"
        self.copyright = "Copyright (c) 2013 Rockwell Game Studio."
 
        #Description
        self.project_description = "R.U.T."
        ...
        self.extra_modules = []
        self.exclude_modules = ["Tkconstants", "Tkinter", "tcl"]
